...
<head><title>HMS | Edit Doctor</title></head>
                        ...
                        <form method="post" enctype="multipart/form-data">
                            <div class="p-5">
                                ...
                                if (isset($_POST['change'])) {
                                    ...
                                    $specializations = $_POST['special'];
                                    $phones = $_POST['phone'];
                                    $feess = $_POST['fee'];
                                    $error = array();
                                    $query = "UPDATE doctor SET specialization = '$specializations',name='$names',email='$emails',address='$addresss',phone='$phones',fees = '$feess' WHERE username='$uname';";
                                    $update = mysqli_query($connect,$query);
                                    if($update){
                                
                                        echo "<script>toastr.success(' Datails Updated Successfully','Success!',);
                                        setTimeout(function() {
