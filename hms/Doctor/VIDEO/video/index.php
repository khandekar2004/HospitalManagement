...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
  ...
  <script>
    ...
    var value = document.getElementById('meetingid').value;
    ...
    fetch('add.php', {
        ...
        body: 'value=' + encodeURIComponent(value) + '&appid='+ encodeURIComponent(appid)
    })
  ...
  <body>
    ...
    <script src="./assets/bootstrap/videosdk.js"></script>
