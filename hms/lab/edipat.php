                        ...
                        <form method="post" enctype="multipart/form-data">
                            <div class="p-5">
                                ...
                                if (isset($_POST['submit'])) {
                                    ...
                                    $medhis = $_POST['medhis'];
                                    $error = array();
                                    $sql = mysqli_query($connect, "UPDATE labpatient set PatientName='$patname',PatientContno='$patcontact',PatientEmail='$patemail',PatientGender='$gender',PatientAdd='$pataddress',PatientAge='$patage',PatientMedhis='$medhis' where ID='$editid'");
                                    if ($sql) {
                                ...
                                <?php
                                $eid = $_GET['editid'];
                                $ret = mysqli_query($connect, "select * from labpatient where ID='$eid'");
                                $cnt = 1;
