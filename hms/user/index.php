                ...
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                        ...
                        $uid=$_SESSION['id'];
                                        ...
                                        $ad = mysqli_query($connect,"SELECT * FROM appointment where userId ='uid'");
            ...
            <div class="row no-gutters align-items-center">
                <div class="col mr-2">
                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                        Your Patient</div>
                        <?php 
                        $stmt = mysqli_query($connect,"SELECT * FROM user WHERE id = $uid ");
                        $row = mysqli_fetch_assoc($stmt);
                        $email = $row['email'];
                        $doc = mysqli_query($connect,"SELECT * FROM tblpatient WHERE PatientEmail = '$email' ");
